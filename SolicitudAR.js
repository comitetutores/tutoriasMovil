    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Acciones Remediales</Text>
        </View>

        <ScrollView contentContainerStyle={styles.contentContainer}>
          <View style={styles.whiteBox}>
            <View style={styles.titleContainer}>
              <Text style={styles.titleText}>SOLICITUD DE ACCIONES
              REMEDIALES</Text>
            </View>

            <Text style={styles.instructionText}>
              Para descargar el formato de{' '}
              <Text style={styles.boldText}>SOLICITUD DE ACCIONES
              REMEDIALES</Text>, presiona el link que está abajo de este texto.
            </Text>
